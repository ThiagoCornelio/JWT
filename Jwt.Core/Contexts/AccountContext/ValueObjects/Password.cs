...
{
    /// <summary>
    /// O código abaixo pode ser substituido com o uso do pacote SecureIdentity, pacote está no nuget.
    /// </summary>
    ...
    {
        var chars = includeSpecialChars ? (Valid + Special) : Valid; //Inclui na geração da senha todos os caracteres.
        var startRandom = upperCase ? 26 : 0; //Caso queira a senha apenas com letras maiúsculas.
        var index = 0;
    ...
    #region 2 - Gera senha criptografada 
    ...
    #region 3 - Verifica se a senha está correta
